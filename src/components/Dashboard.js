                            ...
                            {answeredQuestionsSorted.map(question=>(
                                <li key={question.id}>
                                    <Card style={{ width: '15rem',height: "100%",textAlign:'center'}} >
                                        ...
                                        <Card.Body style={{background: question.author === loggedUser.id?'#FFD65A':'#fff'}}>
                                            <Card.Title>{question.userInfo.name}</Card.Title>
                                            <Card.Text>
                                                <div style={{fontWeight:'normal',height:48}}>...{question.optionOne.text}...</div>
                                                <Button style={{width:'90%',margin:0}} variant="outline-dark" onClick={(e) => showResults(e,question.id,question.userInfo.name,question.userInfo.avatarURL)}>View Poll</Button>
                                            </Card.Text>
                                ...
                                <li key={question.id}>
                                    <Card style={{ width: '15rem' ,height: "100%",textAlign:'center'}}>
                                        ...
                                        <Card.Body style={{background: question.author === loggedUser.id?'#FFD65A':'#fff'}}>
                                            ...
                                            <Card.Text>
                                                <div style={{fontWeight:'normal',height:48}}>...{question.optionOne.text}...</div>
                                                <Button style={{width:'90%',margin:0}} variant="outline-dark"  onClick={(e) => showViews(e,question.id,question.userInfo.name,question.userInfo.avatarURL)}>View Poll</Button>
                                            </Card.Text>
